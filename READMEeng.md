...
Other functions: modulus (|x|), remainder (mod), random number (Rand)
Fraction handling: convert decimal numbers to fractions (Frac)
Memory: MS, MR, M+, MC
History: view the last 20 operations, double-click to paste the result
